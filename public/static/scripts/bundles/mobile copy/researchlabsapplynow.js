...
openResearchLabsApplyNowDialogButton.addEventListener("click", () => {
    ...
    researchLabsApplyNowDialog.style.width = "550px";
    researchLabsApplyNowDialog.style.height = "560px";
        ...
        await fetch('/ApplyForResearchLab', {
            ...
            .then(function (response) {
                ...
                if (data == 'RESEARCHLAB-ACCESS-REQUEST-EXISTS') {
                    ...
                    researchLabsApplyNowDialog.style.width = "350px";
                    researchLabsApplyNowDialog.style.height = "450px";
                }
                else {
                    el.disabled = false;
                    researchLabsApplyNowErrorMessage.style.display = 'block';
