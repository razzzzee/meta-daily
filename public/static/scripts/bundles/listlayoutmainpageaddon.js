...
function InitControls() {
    require(['core'], function (core) {
        ...
        MainContentOverflowContent.style.height = (RightSideFirstContent.getBoundingClientRect().height + RightSideSecondContent.getBoundingClientRect().height) - MainContentHeight + 1500 + "px";
        ...
        MainContentHeaderHeight = MainContentHeader.getBoundingClientRect().height;
...
$(document).ready(function () {
    $(window).scroll(function () {                  // assign scroll event listener  
        ...
        if (currentScroll >= LeftSideContent_1_Scroll_Start && currentScroll <= LeftSideContent_1_Scroll_End + 800) {           // apply position: fixed if you
        ...
        else if (currentScroll >= LeftSideContent_1_Scroll_End + 800) {
        ...
        if (currentScroll >= LeftSideContent_2_Scroll_Start + 600 && currentScroll <= LeftSideContent_2_Scroll_End + 1500) {           // apply position: fixed if you
        ...
        else if (currentScroll >= LeftSideContent_2_Scroll_End + 1500) {
        ...
        if (currentScroll >= RightSideContent_1_Scroll_Start + 500 && currentScroll <= RightSideContent_1_Scroll_End + 1500) {           // apply position: fixed if you
        ...
        else if (currentScroll >= RightSideContent_1_Scroll_End + 1500) {
        ...
        if (currentScroll >= RightSideContent_2_Scroll_Start + 1000 && currentScroll <= RightSideContent_2_Scroll_End + 2000) {           // apply position: fixed if you
        ...
        else if (currentScroll >= RightSideContent_2_Scroll_End + 2000) {
        ...
        if (currentScroll >= MainContentHeight + HeroContentHeight + 220 && currentScroll <= (MainContentOverflowContentHeight + MainContentHeight + HeroContentHeight + 220)) {           // apply position: fixed if you   
        ...
        else if (currentScroll >= MainContentOverflowContentHeight + MainContentHeight + HeroContentHeight + 220) {
        ...
        if (currentScroll >= HeroContentHeight && currentScroll <= (MainContentHeight + HeroContentHeight)) {           // apply position: fixed if you   
            MainContentHeader.style.top = "8%";
            MainContentHeader.style.width = "49%";
        ...
        else if (currentScroll >= MainContentHeight + HeroContentHeight) {
